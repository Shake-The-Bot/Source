-- Revises: V10
-- Creation Date: 2023-06-26 12:00:25.285508 UTC
-- Reason: update
...
CREATE INDEX IF NOT EXISTS counting_message_id_idx ON counting (message_id);
...
CREATE INDEX IF NOT EXISTS countings_guild_id_idx ON countings (guild_id);
CREATE INDEX IF NOT EXISTS countings_channel_id_idx ON countings (channel_id);
CREATE INDEX IF NOT EXISTS countings_user_id_idx ON countings (user_id);
...
CREATE INDEX IF NOT EXISTS countings_failed_idx ON countings (failed);
...
CREATE INDEX IF NOT EXISTS aboveme_message_id_idx ON aboveme (message_id);
...
CREATE TABLE IF NOT EXISTS abovemes (
    id SERIAL PRIMARY KEY,
    channel_id BIGINT,
    guild_id BIGINT,
    user_id BIGINT,
...
CREATE INDEX IF NOT EXISTS abovemes_guild_id_idx ON abovemes (guild_id);
CREATE INDEX IF NOT EXISTS abovemes_channel_id_idx ON abovemes (channel_id);
CREATE INDEX IF NOT EXISTS abovemes_user_id_idx ON abovemes (user_id);
CREATE INDEX IF NOT EXISTS abovemes_used_idx ON abovemes (used);
CREATE INDEX IF NOT EXISTS abovemes_count_idx ON abovemes (count);
...
CREATE INDEX IF NOT EXISTS oneword_message_id_idx ON oneword (message_id);
...
CREATE TABLE IF NOT EXISTS onewords (
    id SERIAL PRIMARY KEY,
    channel_id BIGINT,
    guild_id BIGINT,
    user_id BIGINT,
...
CREATE INDEX IF NOT EXISTS onewords_guild_id_idx ON onewords (guild_id);
CREATE INDEX IF NOT EXISTS onewords_channel_id_idx ON onewords (channel_id);
CREATE INDEX IF NOT EXISTS onewords_user_id_idx ON onewords (user_id);
