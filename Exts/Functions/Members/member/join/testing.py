...
class Event:
    ...
    async def await_captcha(self):
        ...
        embed = ShakeEmbed(
            title=_("Please send the captcha code here"),
        ...
        embed.set_author(
            name=_("Welcome to {guild_name}").format(guild_name=self.member.guild.name),
    ...
    async def __await__(self):
        ...
        #         "SELECT captcha FROM welcome WHERE guild_id = $1 AND turn = $2",
