    ...
    async def listener(self) -> None:
        ...
        while not self.ctx.bot.is_closed():
            ...
            if action == "first":
                ...
                choose_msg = await self.ctx.smart_reply(
...
class command():
    ...
    async def __await__(self):
        ...
        await self.ctx.smart_reply(pager)