useless = {
    'Power': [
        ...
        # wyyy
        # "You can turn invisible, but only when nobody is looking.",
        # "You are invisible to all doors, faucets, soaps, paper towels and hand dryer sensors.",
        # "You can add pedals to any wheelchair that a disabled person is using.",
        # "You can kill everyone using one punch but you don't have hands",
        # "You never have to pee again. But you always feel like you have to pee.",
        # "Your toenails taste like cinnamon, but only to other people",
        # "You are invisible but only to yourself",
        # "You can hear anyone when they talk about you behind your back... but only when they are complementing your a$$",
        # "You can undo the folding marks on any paper you unfold.",
        # "You are able to watch any movie you want whenever you want, but all of the characters look like Danny DeVito.",
        # "You are infinitely intelligent at the cost of losing the ability to talk, type or write (basically relay any information",
        # "You can turn yourself into a furniture.",
        # "You know what time it is if you have a watch on your wrist",
        # "You can listen to and understand animals but can't talk to them.",
        # "You can change the composition of any star big than the nearest star by pointing at it.",
        # "You can turn small amounts of water to lead when fully submerged in the ocean",
        # "You have the ability to fly! But you're scared of heights forever...",
        # "You can chew two different flavors of gum at the same time without getting combining the flavors.",
        # "You can go through walls but you can't get out",
        # "You glow in the dark but only when you close your eyes",
        # "You can spawn any soda at will, but it will always be flat",
        # "You can turn your fingers into any type of gun, but you can't never touch anyone or anything you don't want to destroy",
        # "You can enumerate all the numbers from 1 to a google in any order without losing track of any. You also know how to read them all.",
        # "You can make balloons that are filled with helium go down.",
        # "You can unlock all the smartphones in the world but only if the owner is ok with it",
        # "You have a glass that's filled infinite with water, but the water is always way too salty.",
        # "You can always guess the first letter of whatever people is thinking on at the moment.",
        # "You can summon any video game character you want, but only while using them in game. They are also confined inside the game, they cannot escape to reality. Releases when game ends (leaving, crashing, corrupted, you lose/win, etc..",
        # "You can swap places of two nearly identical objects on your sight.",
        # "You can suck people into your butthole",
...
useful = {
    "Power": [
        ...
        # wyyy
        # "You can get as drunk or high as you want without any negative effects,only the positives.",
        # "You gain immortality but can choose to die whenever you please by saying „fuck this shit I'm out“",
        # "You never run out of comebacks, and can precisely predict any insults the other person is gonna say",
        # "You can mentally grab someone's ip through a video game and subconsciously order an excessive amount of pineapple pizza to their house without spending a dime",
        # "You gain all the abilities and items from every single video game where you have at least one hour total playtime",
        # "You can get rid of people's addictions by just saying „Get over it“",
        # "Your chance of the person saying „yes“ when you ask them out increases by 50%",
        # "You can eat infinite food without getting fat",
        # "You can summon a perfect version of any product: food, tech, chemicals, weapons, tools etc.",
        # "You become the last character you played as in any game for an hour(get abilitys, items, powers, ect.",
        # "You have a pocket dimension in your pockets, where you can grab any item that you want or need.",
        # "You have an irl minecraft inventory, no weight limit, 64 per stack.",
        # "You can change the color and pattern of your eyes",
        # "You can make anything have the opposite effect of what was supposed to be",
        # "You can always lucid dream when you sleep",
        # "Your burrito doesn't fall apart",
        # "You have a Life Navigator, in short, it shows you the goals you want to achieve. For example you want $1 million? here's the way, you want to impress the girl next door? here is the way to it and so on.",
        # "Your pocket can hold 10 items no matter what size they are",
        # "You can summon a raccoon henchmen that is capable of any task, including murder.",
        # "You can recover from any injury, death included, on the condition that when questioned on it you say „i got better“and refuse to elaborate further.",
        # "You own the rights to any word you want, then if someone says it you get 20$",
        # "You gain 2000% strength for 15 seconds after being hit in the balls",
        # "You only need to watch one 10 minute YouTube totorial and you are now a master of the video's subject.",
        # "You get all powers you upvote",
        # "You can say „fuck this shit“ and you automatically don't have to do it anymore",
        # "You are 100% silent when you tiptoe",
        # "Your body no longer requires sleep, therefore it will perform at 100% without sleeping. However, choosing to sleep will give extra benefits (e.g. more energy, better focus, etc. and sleeping wont take your ability away.",
        # "You get 3% smarter every time someone calls you dumb",
        # "You can download mods to your life",
        # "Your pockets have infinite inventory space.",
        # "You have 9 lives, everytime you die you get ressurected before the events leading to your death",
        # "You have the power to bring your OC's to the real world",
        # "You can get into any account just by putting „password“ as their password",
        # "You have the power to pause online games",
        # "You can now see everybody's S.P.E.C.I.A.L stats, including your own (Strength, Perception, Endurance, Charisma, Intelligence, Agility and Luck.",
        # "You get maximum comfort when sleeping in any position",
        # "You can replay a day as many times as you want, and fix your mistakes",
        # "You can install a universal adblocker on any phone or computer you touch",
        # "You can summon a random person to do any task you want",
    ]
}