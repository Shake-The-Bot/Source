...
class command():
    ...
    async def __await__(self): 
        ...
        embed.add_field(
            inline=False, name=_("{emoji} The benefit of supporting Shake with Voting").format(emoji=self.bot.emojis.dot),
            value=_(
                ...
                **Thanks for every vote!!**
                """))
        embed.add_field(
            inline=False, name=_("{emoji} Sites the bot is listed at").format(emoji=self.bot.emojis.dot),
            value=_(
                ...
                **[Vote for Shake on infinitybots.gg]({infinitybots})**""").format(
                    topgg=self.bot.config.other.topgg.vote, discordbotlist=self.bot.config.other.discordbotlist.vote,
                    botlisteu=self.bot.config.other.botlisteu.vote, infinitybots=self.bot.config.other.infinitybots.vote
                )
        )
        embed.add_field(
            inline=False, name=_("{emoji} Other related links").format(emoji=self.bot.emojis.dot),
            value=_(
                """**[Shake on Discord Bots]({discordbots})**
                **[Shake's Server on Discords]({discords})**""").format(
...
class Button(ui.View):
    def __init__(self, bot):
        ...
        button = ui.Button(
                ...
                label=_("Vote for Shake"), url=self.bot.config.other.authentication)
